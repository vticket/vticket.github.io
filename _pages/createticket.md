								...
								<div class="form-validation">
                                    <div class="needs-validation" novalidate >
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="mb-3 row">
                                                    <label class="col-lg-3 col-form-label" for="validationCustom01">Ticket Subject
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-3 col-form-label" for="validationCustom02">Email address<span
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-3 col-form-label" for="validationCustom03">Ticket Category
                                                        <span class="text-danger">*</span>
                                                    </label>
												...
												<div class="row mb-3">
													<div class="col-xl-3">
													  <label class="col-lg-10 col-form-label" for="validationCustom04">Ticket Description <span
														class="text-danger">*</span>
													  </label>
													</div>
													<div class="col-xl-9">
												...
												<div class="row mb-3">
													<label class="col-lg-3 col-form-label" for="validationCustom04">
														Attatchment <span class="text-danger">*</span>
                                                    </label>
													<div class="col-xl-9">
