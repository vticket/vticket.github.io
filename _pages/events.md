								...
								<div class="card">
									<div class="card-body p-4">
										<div class="media align-items-center">
											<span class="me-3">
												<span class="donut" data-peity='{ "fill": ["var(--primary)", "var(--rgba-primary-1)"]}'>5/8</span>
											</span>
											<div class="media-body">
												<div class="d-flex align-items-center">
													<h2 class="mb-0 me-3 text-black font-w600">25 Left</h2>
												</div>
												<p class="mb-0">Available Ticket</p>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-xl-12 ">
								<div class="card event-bx">
									<div class="card-media">
										<img class="rounded" src="images/card/4.png" alt="">
										<div class="overlay-bx row p-3 p-xl-5 ">
											<div class="col-lg-6 p-0">
												<h2 class="text-white mb-4">Beautiful Fireworks Show In The New Year Night 2020.</h2>
												...
												<svg class="me-3" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M0.648682 9.33093V14.3327C0.648682 15.2524 1.39695 16 2.31594 16H14.3203C15.2399 16 15.9875 15.2524 15.9875 14.3327V9.33093H0.648682Z" fill="white"></path>
													<path d="M7.89524 1.52481L5.39966 2.11702L7.49041 5.19347L10.1934 4.5786L7.89524 1.52481Z" fill="white"></path>
													<path d="M4.70626 2.28177L2.0166 2.91931L4.08535 5.9671L6.79232 5.35153L4.70626 2.28177Z" fill="white"></path>
													<path d="M15.9768 2.90997L15.4092 0.757192C15.2785 0.23366 14.7423 -0.0957707 14.2135 0.0249289L11.9727 0.55712L14.0988 3.69159L15.728 3.3208C15.8167 3.30079 15.8927 3.24543 15.9394 3.16809C15.9861 3.09075 15.9995 2.998 15.9768 2.90997Z" fill="white"></path>
													<path d="M11.2785 0.721863L8.60352 1.35675L10.9057 4.41719L13.4006 3.84964L11.2785 0.721863Z" fill="white"></path>
													<path d="M4.00918 5.99707L2.94214 8.66404H5.55843L6.62547 5.99707H4.00918Z" fill="white"></path>
													<path d="M7.34389 5.99707L6.27686 8.66404H8.89311L9.96018 5.99707H7.34389Z" fill="white"></path>
													<path d="M15.6541 5.99707H14.0128L12.9458 8.66469H15.9875V6.3305C15.9875 6.14578 15.8388 5.99707 15.6541 5.99707Z" fill="white"></path>
													<path d="M10.6784 5.99707L9.61133 8.66404H12.227L13.2947 5.99707H10.6784Z" fill="white"></path>
											...
											<div class="col-lg-6 p-0 d-flex align-items-end justify-content-end">
												<div class="dropdown ms-3">
													<button type="button" class="btn rounded border-white p-2" data-bs-toggle="dropdown">
									...
									<div class="card-body">
										<div class="row align-items-center">
											<div class="col-xl-8 col-xxl-12">
												<div class="border-end pe-md-5">
													<h3 class="text-black">Event Description</h3>
													...
													<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it book.</p>
												</div>
											</div>
												...
												<div class="media mb-4 align-items-center">
													<div class="me-3">
														<svg width="24" height="24" viewBox="0 0 14 25" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M6.07438 25H7.95454V22.6464C11.8595 22.302 14 19.6039 14 16.8197C14 12.7727 10.8471 11.9977 7.95454 11.3088V5.10907C9.34297 5.4535 10.1529 6.5155 10.2686 7.66361H13.7975C13.5372 4.42021 11.281 2.61194 7.95454 2.32492V0H6.07438V2.35362C2.4876 2.66935 0 4.87945 0 8.09415C0 12.1412 3.18182 12.9449 6.07438 13.6625V19.977C4.45455 19.69 3.64463 18.628 3.52893 17.1929H0C0 20.4363 2.54545 22.3594 6.07438 22.6751V25ZM10.6736 16.992C10.6736 18.4845 9.69008 19.69 7.95454 19.977V14.1504C9.51653 14.6383 10.6736 15.3559 10.6736 16.992ZM3.35537 7.92193C3.35537 6.17107 4.48347 5.22388 6.07438 5.02296V10.8209C4.5124 10.333 3.35537 9.58668 3.35537 7.92193Z" fill="var(--primary)"></path>
														</svg>
													</div>
													<div class="media-body">
														<p class="mb-1">Ticket Price</p>
														<h4 class="mb-0 text-black">$124,00</h4>
													</div>
												</div>
												<div class="media mb-4 align-items-center">
													<div class="me-3">
													...
													<div class="media-body">
														<p class="mb-1">Date</p>
														<h4 class="mb-0 text-black">Sunday,12 june 2020</h4>
													</div>
												</div>
												<div class="media mb-4 align-items-center">
													<div class="me-3">
													...
													<div class="media-body">
														...
														<h4 class="mb-0 text-black">Blue Corner St.123566 Franklin Avenue,London</h4>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-xl-12">
								<div class="card bg-transparent shadow-none">
									<div class="card-header ps-0 border-0">
										<h4 class="card-title">Recent Sales</h4>
									</div>
									<div class="card-body p-0 bg-white rounded shadow">
										<div class="table-responsive">
											<table class="table fs-14 table-responsive-md">
												<thead>
													<tr>
														<th>Order ID</th>
														<th>Date</th>
