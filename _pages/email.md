				...
				<div class="row">
					<div class="col-xl-12">
						<div class="row page-titles mt-3 ">
							<ol class="breadcrumb align-items-center justify-content-between mt-sm-0 mt-2">
								<li class="breadcrumb-item"><a href="javascript:void(0)">CMS</a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0)">Email Template</a></li>
								<li class="dropdown ms-auto my-2 my-sm-0">
						...
						<div class="mb-3">
							<ul class="d-flex align-items-center">
								<li><a href="add-email.html" class="btn btn-primary">New Email Template</a></li>
							</ul>
						</div>
											...
											<table class="table table-responsive-lg">
												...
												<tbody>
													<tr>
														...
														<td><a href="javascript:void(0);" class=" btn btn-primary btn-sm content-icon status"><i class="fas fa-check"></i></a></td>
														<td>02 Feb, 2015</td>
														<td>
													...
													<tr>
														<td>2</td>
														<td>create store</td>
														<td><a href="javascript:void(0);" class=" btn btn-primary btn-sm content-icon"><i class="fas fa-check"></i></a></td>
														<td>02 Feb, 2015</td>
														<td>
