			...
			<div class="container-fluid">
                <div class="row mb-5 align-items-center">
					<div class="col-xl-3 align-self-start ">
						<div class="card mb-2 bgl-primary">
							<div class="card-body px-4 py-3">
								<div class="media align-items-center">
									...
									<div class="media-body ms-1">
										<h5 class="mb-0 text-primary font-w600">Generate Report</h5>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card m-0 ">
							<div class="card-body px-4 py-3 py-lg-2">
								<div class="row align-items-center">
									<div class="col-xl-3 col-xxl-12 col-lg-12">
										<p class="mb-2 fs-14">Lorem Ipsum is simply dummy text of the printing and</p>
									</div>
												...
												<div class="media align-items-center">
													<span class="me-3">
														<svg width="30" height="19" viewBox="0 0 30 19" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path fill-rule="evenodd" clip-rule="evenodd" d="M29.3124 0.990819C30.1459 1.71561 30.234 2.97887 29.5092 3.81239L20.7578 13.8765C19.359 15.4851 16.9444 15.7141 15.2681 14.397L11.1176 11.1359L3.87074 17.9564C3.06639 18.7135 1.80064 18.6751 1.04361 17.8708C0.286573 17.0664 0.324929 15.8007 1.12928 15.0436L8.3761 8.22309C9.817 6.86695 12.0329 6.76812 13.5888 7.99062L17.7394 11.2518L26.4908 1.18767C27.2156 0.354158 28.4788 0.266024 29.3124 0.990819Z" fill="var(--primary)"/>
														</svg>
													</span>
													<div class="media-body ms-1">
														<p class="mb-0 fs-12">Customer</p>
														<h4 class="mb-0 text-black font-w600  fs-22">765 Person</h4>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-md-4 col-sm-4">
												<div class="media align-items-center">
													...
													<div class="media-body ms-1">
														...
														<h4 class="mb-0 text-black font-w600  fs-22">$126,000</h4>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-md-4 col-sm-4">
												<div class="media align-items-center">
													...
													<div class="media-body ms-1">
														...
														<h4 class="mb-0 text-black font-w600 fs-22">72%
                ...
                <div class="row">
					<div class="col-lg-12">
						<div class="table-responsive table-hover fs-14">
							<table class="display mb-4 dataTablesCard " id="example5">
								<thead>
									<tr>
										<th>Order ID</th>
										<th>Date</th>
								...
								<tbody>
									<tr>
										...
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$125,70</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
										...
										<td>567k left</td>
										<td class="text-black"><strong>NO</strong></td>
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$536,00</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
										...
										<td>3 pcs</td>
										<td>567k left</td>
										<td class="text-danger"><strong>Refund</strong></td>
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$124,55</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
									...
									<tr>
										...
										<td>567k left</td>
										<td class="text-black"><strong>NO</strong></td>
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$65,22</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
										...
										<td>567k left</td>
										<td class="text-black"><strong>NO</strong></td>
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$44,00</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
										...
										<td>567k left</td>
										<td class="text-danger"><strong>Refund</strong></td>
										<td><a href="javascript:void(0);" class="btn text-primary bgl-primary rounded btn-sm">$51,50</a></td>
									</tr>
									<tr>
										<td>#0012451</td>
										<td>04/08/2020 12:34 AM</td>
