								...
								<div class="row align-items-center">
									<div class="col-sm-12 col-md-7">
										<ul class="nav nav-pills review-tab">
											...
											<li class="nav-item">
												<a href="#navpills-3" class="nav-link px-2 px-lg-3" data-bs-toggle="tab" aria-expanded="true">Deleted</a>
											</li>
										</ul>
									</div>
									...
									<table class="display mb-4 dataTablesCard fs-14" id="example5">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="media align-items-center">
														<img class="img-fluid rounded me-3 d-none d-xl-inline-block" width="70" src="images/avatar/2.jpg" alt="DexignZone">
														<div class="media-body">
											...
											<tr>
												...
												<td>
													<div class="media align-items-center">
														<img class="img-fluid rounded me-3 d-none d-xl-inline-block" width="70" src="images/avatar/3.jpg" alt="DexignZone">
														<div class="media-body">
											...
											<tr>
												<td>
													<div class="checkbox me-3 align-self-center">
														<div class="custom-control custom-checkbox checkbox-info">
															<input type="checkbox" class="form-check-input" id="customCheckBox006" required="">
										...
										<tbody>
											...
											<tr>
												<td>
													<div class="checkbox me-3 align-self-center">
														<div class="custom-control custom-checkbox checkbox-info">
															<input type="checkbox" class="form-check-input" id="customCheckBox0007" required="">
