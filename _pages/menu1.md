							...
							<div class="cm-content-body form excerpt">
								<div class="card-body">
									<div class="row align-items-center p-3">
										...
										<div class="col-xl-6 col-xxl-5 mb-xl-0 mb-3 Cms-selecter">
						...
						<div class="row">
							<div class="col-xl-5">
								<div class="filter cm-content-box box-primary">
									...
									<div class="cm-content-body form excerpt">
										<div class="card-body">
											<div class="filter cm-content box-primary">
												<div class="content-title">
													<div class="cpa">
														page
													</div>
												...
												<div class="cm-content-inner form excerpt">
													<div class="card-body">
														...
														<div class="tab-content" id="myTabContent">
															<div class="tab-pane fade show active" id="Viewall-tab-pane" role="tabpanel" aria-labelledby="Viewall-tab" tabindex="0">
																<div class="menu-tabs">
																	...
																	<div class="d-flex align-items-center flex-wrap">
																		<a href="javascript:void(0);" class="text-primary">Select All</a><span class="mx-2">|</span>
																		<a href="javascript:void(0);" class="text-primary me-2">Deselect All</a>
																	</div>
																</div>
															</div>
															...
															<div class="d-flex align-items-center flex-wrap">
																...
																<button type="submit" class="btn btn-primary dalb-menu-btn">Add to Menu</button>
															</div>
														</div>
													</div>
							...
							<div class="col-xl-7">
								<div class="filter cm-content-box box-primary">
									<div class="content-title flex-wrap">
										...
										<button type="submit" class="btn btn-secondary ms-sm-auto mb-2 mb-sm-0">Save Menu</button>
									</div>
									<div class="cm-content-body form excerpt">
										<div class="card-body">
											<h6 class="mb-0">Menu Structure</h6>
											<p>Add menu items from the column on the left.</p>
											<div class="col-xl-8 nestable">
												<div class="dd" id="nestable">
													<ol class="dd-list ps-0">
																...
																<div class="accordion-item">
																	<div class="accordion-header" id="heading-1">
																	  ...
																	  <button class="accordion-button contact" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
																		Contact Us <span class="badge badge-primary ms-2">Category</span>
																	  </button>
																	</div>
																		...
																		<div class="accordion-body" id="nestable2">
																			<div class="row">
																				<div class="col-xl-12">
																					<form>
																					  <div class="mb-3">
																						...
																						<input type="text" class="form-control" placeholder="http://rahul/projects/cakemultishop/contacts">
																					  </div>
																					</form>													
																				</div>
																				<div class="col-xl-6">
																				...
																				<div class="d-flex align-items-center">
																					<a href="javascript:void(0);" class="text-danger">Remove</a><span class="mx-2">|</span>
																...
																<div class="accordion-item">
																	<div class="accordion-header" id="heading-2">
																	  ...
																	  <button class="accordion-button contact" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="true" aria-controls="collapse-2">
																		Privacy Policy <span class="badge badge-primary ms-2">Lifestyle</span>
																	  </button>
																	</div>
																	<div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionExample-2">
																		<div class="accordion-body">
																			<div class="row">
																				...
																				<div class="col-xl-12">
																					<p class="dlab-terms">Original: <a href="javascript:void(0);">Privacy Policy</a></p>
																				</div>
																				<div class="d-flex align-items-center">
																					<a href="javascript:void(0);" class="text-danger">Remove</a><span class="mx-2">|</span>
																					<a href="javascript:void(0);">Cancel</a>
																...
																<div class="accordion-item">
																	<div class="accordion-header" id="heading-3">
																	  ...
																	  <button class="accordion-button contact" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3">
																		Terms and Conditions <span class="badge badge-primary ms-2">Food</span>
																	  </button>
																	</div>
																	<div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="heading-3" data-bs-parent="#accordionExample-3">
																		<div class="accordion-body">
																			<div class="row">
																				...
																				<div class="col-xl-12">
																					<p class="dlab-terms">Original: <a href="javascript:void(0);">Terms and Conditions</a></p>
																				</div>
																				<div class="d-flex align-items-center">
																					<a href="javascript:void(0);" class="text-danger">Remove</a><span class="mx-2">|</span>
																					<a href="javascript:void(0);">Cancel</a>
																...
																<div class="accordion-item">
																	<div class="accordion-header" id="heading-4">
																	  ...
																	  <button class="accordion-button contact" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4">
																		About Us <span class="badge badge-primary ms-2">Beautiy</span>
																	  </button>
																	</div>
																	<div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="heading-4" data-bs-parent="#accordionExample-4">
																		<div class="accordion-body">
																			<div class="row">
																				...
																				<div class="col-xl-12">
																					<p class="dlab-terms">Original: <a href="javascript:void(0);">About Us</a></p>
																				</div>
																				<div class="d-flex align-items-center">
																					<a href="javascript:void(0);"class="text-danger">Remove</a><span class="mx-2">|</span>
																					<a href="javascript:void(0);">Cancel</a>
																...
																<div class="accordion-item">
																	<div class="accordion-header" id="heading-5">
																	  ...
																	  <button class="accordion-button contact" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="true" aria-controls="collapse-5">
																		Important Information <span class="badge badge-primary ms-2">Fashion</span>
																	  </button>
																	</div>
									...
									<div class="filter cm-content-box box-primary style-1 mb-0 border-0">
										<div class="content-title">
											...
											<button type="submit" class="btn btn-secondary my-2">Save Menu</button>
										</div>
									</div>
								</div>
							</div>
